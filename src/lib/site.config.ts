...
export const siteConfig = {
  ...
  // ---- SEO ----
  seo: {
    defaultTitle: '奇点研究社 - 科技测评与研究',
    titleTemplate: '%s | 奇点研究社',
    keywords: [
      // 品牌词
      '奇点', '奇点研究社', '奇博士', 'qidian', 'qidianyanjiushe',
      // 业务词
      '科技', '科技测评', 'AI测评', '人工智能测评', '科技研究',
      'AI', '人工智能', '大模型', '具身智能', 'AI硬件', 'AI应用',
      '零售电商', '手机数码', 'IP游戏',
      // 内容词
      '科技新闻', '科技资讯', 'AI资讯', '技术解读', '深度测评',
      '科技评论', '商业分析', '科技商业',
    ],
    // 百度搜索资源平台验证（在百度搜索资源平台获取）
    baiduVerification: '',
  },
};
